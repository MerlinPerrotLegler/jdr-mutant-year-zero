...
def update_entity_counts(progress: Progress, vault_path: str) -> None:
    """Recount entities from the vault file system."""
    vault = Path(vault_path)
    mapping = {
        "roles": "01-Regles/Personnage/Roles",
        "talents": "01-Regles/Personnage/Talents",
        "competences": "01-Regles/Personnage/Competences",
        "mutations": "01-Regles/Personnage/Mutations",
        "pnj": "04-PNJ",
        "lieux": "02-Lieux",
